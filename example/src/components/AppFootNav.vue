  ...
  <div :class="css.nav">
    <dl :class="css.nav__list">
      <div v-if="previousPage">
        <dt :class="css.nav__item">Previous</dt>
        <dd class="mt-1">
          <RouterLink :class="css.nav__link" :to="previousPage.to">
            <span aria-hidden="true">&larr;</span> {{ previousPage.title }}
          </RouterLink>
        </dd>
      </div>
      <div v-if="nextPage" :class="css.nav__next">
        <dt :class="css.nav__item">Next</dt>
        <dd class="mt-1">
          <RouterLink :class="css.nav__link" :to="nextPage.to">
